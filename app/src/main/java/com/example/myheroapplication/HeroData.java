...
public class HeroData {
    static String[] heroName = {"Black Widow","Captain America","Colossus","Iron Man","Wolverine"};
    static String[] shortDescription ={
            "Master in the covert arts of espionage, infiltration & subterfuge",
            "Master martial artist and hand-to-hand combatant",
            "Transform his entire body into a form of organic steel",
    ...
    static Integer[] heroImage = {R.drawable.black_widow, R.drawable.captain_america, R.drawable.colossus, R.drawable.iron_man, R.drawable.wolverine};
}
